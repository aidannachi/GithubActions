[![Run App Nachi, Aidan](https://github.com/aidannachi/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/aidannachi/GithubActions/actions/workflows/run-app.yaml)
