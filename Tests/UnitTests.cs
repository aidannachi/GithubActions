...
{
    [TestMethod]
    public void Subtract_Valid_Nachi()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Nachi()
    {
        Assert.ThrowsException<FormatException>(() => Program.Subtract("a", "1"));
        Assert.ThrowsException<FormatException>(() => Program.Subtract("1", "b"));
        Assert.ThrowsException<FormatException>(() => Program.Subtract("a", "b"));
    }

    [TestMethod]
    public void Subtract_Null_Nachi()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Nachi()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Nachi()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Nachi()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Nachi()
    {
    ...
    [TestMethod]
    public void Divide_Invalid_Nachi()
    {
        Assert.ThrowsException<FormatException>(() => Program.Divide("a", "1"));
        Assert.ThrowsException<FormatException>(() => Program.Divide("1", "b"));
        Assert.ThrowsException<FormatException>(() => Program.Divide("a", "b"));
    }

    [TestMethod]
    public void Divide_Null_Nachi()
    {
...
public class PowerTests
{
    ...
    [TestMethod]
    public void Power_Invalid_Nachi()
    {
